(function ($) {
    ...
    //var z_index = 1000000;  //commented for rrajt logistics management
    ...
    $.fn.draggableTouch = function (action) {
        ...
        this.each(function () {
            ...
            $element.bind("touchstart.draggableTouch", function (e) {
                ...
                //z_index++; //commented for rrajt logistics management
                //$element.css('z-index', z_index);  //commented for rrajt logistics management
